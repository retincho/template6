...
class NationalitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create nationality" do
    assert_difference('Nationality.count') do
      post nationalities_url, params: { nationality: { code: @nationality.code, country_id: @nationality.country_id, name: @nationality.name } }
    end
  ...
  test "should update nationality" do
    patch nationality_url(@nationality), params: { nationality: { code: @nationality.code, country_id: @nationality.country_id, name: @nationality.name } }
