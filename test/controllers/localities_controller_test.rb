...
class LocalitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create locality" do
    assert_difference('Locality.count') do
      post localities_url, params: { locality: { category: @locality.category, department_id: @locality.department_id, lat: @locality.lat, lon: @locality.lon, name: @locality.name, national_id: @locality.national_id } }
    end
  ...
  test "should update locality" do
    patch locality_url(@locality), params: { locality: { category: @locality.category, department_id: @locality.department_id, lat: @locality.lat, lon: @locality.lon, name: @locality.name, national_id: @locality.national_id } }
